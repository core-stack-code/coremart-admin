                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground mb-0.5">Name</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground mb-0.5">Account Email</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground mb-0.5">User ID</p>
                                    <p className="text-xs text-foreground font-mono bg-muted px-2 py-1 rounded inline-block">
                                        {user.id}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3">
                                <Icon name="User" className="w-4 h-4 mt-0.5 text-muted-foreground" />
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground mb-0.5">Receiver Name</p>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground mb-0.5">Contact</p>
                                    <p className="text-foreground">{customerDetails.mobile}</p>
                                    <p className="text-sm text-muted-foreground break-all">{customerDetails.email}</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                            ...
                            {customerDetails.note && (
                                <div className="flex items-start gap-3 pt-2">
                                    ...
                                    <div className="bg-amber-50 dark:bg-amber-500/10 p-3 rounded-md border border-amber-200 dark:border-amber-500/20 w-full">
                                        <p className="text-sm font-medium text-amber-700 dark:text-amber-400 mb-0.5">Customer Note</p>
                                        <p className="text-sm text-amber-800/80 dark:text-amber-200/80 italic">
                                            "{customerDetails.note}"
                                        </p>
                                    </div>
                                </div>
