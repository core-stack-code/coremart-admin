...
const CreateProductForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-6xl mx-auto py-6 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <Typography variant="h3">Add New Product</Typography>
                    <Typography variant="muted" className="text-muted-foreground mt-1">
                        Fill out the details to create a new product in your catalog.
                    </Typography>
                </div>
